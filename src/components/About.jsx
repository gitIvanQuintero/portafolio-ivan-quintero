		...
		>
			<div className="max-w-7xl w-full grid md:grid-cols-2 gap-12 items-center">
				...
				<div className="container mx-auto px-6 text-center fade-in-right">
					<h1 className="text-5xl sm:text-6xl lg:text-left font-semibold tracking-tight text-gray-900">
						<span className="relative inline-block">
							<svg
								...
								viewBox="0 0 249 22"
								fill="currentColor"
								className="absolute left-0 top-[-0.6em] w-full h-full text-[#b8dacf]"
							>
							...
							<span className="relative text-slate-900">Construyendo</span>
						</span>{' '}
						soluciones digitales con valor
					</h1>

					<p className="mt-6 text-lg leading-8 text-gray-600 lg:text-left">
						Soy Ingeniero en Telecomunicaciones con experiencia en desarrollo de Software FullStack. Me enfoco en crear soluciones que optimicen procesos y generen valor. Me especializo en productos eficientes y funcionales, con el objetivo de mejorar la experiencia del usuario.
						Me destaco por mantener buenas relaciones con compañeros y clientes, trabajar en equipo con actitud positiva, y aportar responsabilidad, pensamiento analítico y compromiso con la mejora continua.
					</p>
					...
					<div className="mt-10 flex justify-between items-center">
						...
						<div className="flex gap-6">
							<a
								...
								className="text-slate-600 hover:text-blue-600 transition-colors duration-200 text-2xl animate-wobble-icon"
								aria-label="LinkedIn"
							>
								<FaLinkedin />
							</a>
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="text-slate-600 hover:text-black transition-colors duration-200 text-2xl animate-wobble-icon"
								aria-label="GitHub"
							>
								<FaGithub />
							</a>
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="text-slate-600 hover:text-pink-500 transition-colors duration-200 text-2xl animate-wobble-icon"
