...
const About = () => {
	return (
		<section
			id="about"
			className="w-full min-h-screen flex items-center justify-center px-6 pt-24 ms:pt-16"
		>
				...
				<div className="container mx-auto px-6 text-center fade-in-right">
					<h1 className="text-5xl sm:text-6xl lg:text-left font-semibold tracking-tight text-gray-900 dark:text-white">
						<span className="relative inline-block">
							...
							<span className="relative text-slate-900 dark:text-white">Construyendo</span>
						</span>{' '}
